...
const faqData = {
  ...
  75: { 
    q: "모의토플 시험은 반드시 응시해야 하나요?", 
    a: "네, 한양인터칼리지 신입생은 Bootcamp와 더불어 모의토플도 반드시 응시해야 합니다. 수시합격생의 경우 Bootcamp 기간에 한양대학교에서 모의토플 응시 예정입니다. 정시 합격생의 모의토플 일정은 Bootcamp 일정과 함께 추후 공지 예정입니다." 
  },
  76: { 
    q: "수시합격생 대상 Bootcamp 신청은 언제 받나요?", 
    a: "한양인터칼리지 신입생이라면 Bootcamp 참여가 필수이며, 기본 인적사항 확인을 위해 별도로 신청서 제출(구글폼 활용)이 필요합니다. Bootcamp 신청은 2025년 12월 29일(월)~2026년 1월 2일(금), 5일간 진행됩니다. Bootcamp 신청 시 기숙사도 함께 신청해야 기숙사 배정 작업을 진행할 수 있습니다." 
  }
};
