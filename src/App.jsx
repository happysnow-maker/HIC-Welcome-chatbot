  ...
  <div>
    ...
    />
                  ...
                  {open && (
                    <div className="px-3 pb-3">
                      <button
                        ...
                        className="w-full mt-2 text-left text-[13px] rounded-lg bg白/10 border border-white/10 px-3 py-2 hover:bg-white/20 transition"
                      >
                        전체 보기 <span className="ml-2 text-slate-300">({data.ids.length})</span>
                      </button>
                    </div>
                  )}
                </div>
        ...
        <div className="mt-auto p-4">
          ...
          <div className="mt-3 p-4 border-t border-white/10 text-xs text-slate-200 text-center">
            기타 문의사항이 있는 경우에는{" "}
            <a
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="border-b border-white/10 bg-white/5 backdrop-blur-xl">
          <div className="px-8 py-6">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight">한양인터칼리지, 궁금하냥?</h2>
