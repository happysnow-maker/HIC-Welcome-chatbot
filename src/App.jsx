...
const faqData = {
  ...
  71: {
    ...
    a: "수시 합격생: 2026년 2월 9일(월)~13일(금) 총 5일간. 정시 합격생: 추후 공지 예정입니다.",
  },
  72: {
    q: "Bootcamp에서는 무엇을 배우게 되나요?",
    a: "다양한 학문적 관점과 기술을 융합하여 복잡한 문제를 다루는 분석적, 알고리즘적 사고체계를 학습합니다.",
  },
  73: { q: "Bootcamp 참여를 위한 필수 준비물이 있나요?", a: "1학년 교육과정을 위해 노트북이 반드시 필요합니다." },
  74: {
    q: "지방에 사는 학생인데 Bootcamp 기간 동안 기숙사가 제공되나요?",
    a: "네, Bootcamp 기간 동안 기숙사가 제공되며, 주소지 원거리 기준으로 선발됩니다.",
  },
